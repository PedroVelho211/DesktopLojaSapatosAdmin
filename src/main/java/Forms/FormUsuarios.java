...
public class FormUsuarios extends javax.swing.JFrame {
     ...
     */
    public FormUsuarios(FormMenu menu) {
        initComponents();
        ...
        displayTable(getAllUsuarios(),jTable1);
    }
    ...
    private void initComponents() {
        ...
        btnExcluir.setBackground(new java.awt.Color(255, 133, 133));
        ...
        btnCadNovo.setBackground(new java.awt.Color(255, 165, 0));
        btnCadNovo.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        btnCadNovo.setText("Cadastrar Novo");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(67, 67, 67)
                                .addComponent(rbAdministrador, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(rbAtendente, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(rbCaixa, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(btnCadNovo, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnCadNovo, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnCadNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadNovoActionPerformed
        ...
        if (rbAdministrador.isSelected()) {
            cargo = rbAdministrador.getText();
        } 
        else if (rbAtendente.isSelected()) {
            cargo = rbAtendente.getText();
        } 
        else {
            cargo = rbCaixa.getText();
        }
...
//    public void table(String cargo) {
//        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
//        
////        for(int i = 0; i < 2; i++){
...
//    }
    ...
    public void displayTable(List<Usuario> usuarios, JTable jTable) {
    ...
    for (Usuario usuario : usuarios) {
        model.addRow(new Object[]{
            ...
            usuario.getSenha(),
            usuario.getTipo(),
            (usuario.getFuncionario() != null) ? usuario.getFuncionario().getNome() : "N/A" // Assuming Funcionario has a "getNome()" method
        });
    }
