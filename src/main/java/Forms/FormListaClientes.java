 ...
 * @author User
 */
public class FormListaClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnStatus.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        btnStatus.setForeground(new java.awt.Color(0, 0, 0));
        btnStatus.setText("Mudar Status");
        ...
        btnRemover.setBackground(new java.awt.Color(255, 133, 133));
        ...
        tblClientes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Kiana Kaslana", "51 999 999 999", "99 999 999 999", "Premium"},
                {null, null, null, "Normal"},
                {null, null, null, null},
                {null, null, null, null}
            },
            new String [] {
                "Nome", "Contato", "CPF", "Status"
            }
        ));
...
//                        this,
//                        "Mudar status deste cliente para: NORMAL ?",
//                        "Confirmar Alteração",
...
//        }
        ...
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) tblClientes.getModel();
            Object obj = model.getValueAt(tblClientes.getSelectedRow(), 3);
            ...
            int resposta = JOptionPane.showConfirmDialog(this, "Mudar status deste cliente para: " + status + " ?");
            if (resposta == JOptionPane.YES_OPTION && "Premium".equals(status)) {
                model.setValueAt("Premium", tblClientes.getSelectedRow(), 3);
            } else if (resposta == JOptionPane.YES_OPTION && "Normal".equals(status)) {
                model.setValueAt("Normal", tblClientes.getSelectedRow(), 3);
            } else {
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        try {
            ...
            if (obj != null) {
                ...
                int resposta = JOptionPane.showConfirmDialog(this, "Remover Cliente?");
...
//            java.util.logging.Logger.getLogger(FormListaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new FormListaClientes().setVisible(true);
//            }
//        });
//    }
